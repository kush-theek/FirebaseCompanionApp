...
import com.sap.cloud.mobile.flowv2.ext.ActivationOption
...
import com.theektek.validatesub.databinding.ActivitySplashBinding
        ...
        val flowContext =
                FlowContextBuilder()
                    ...
                    .setFlowOptions(FlowOptions(
                            ...
                            fullScreen = false,
                            signedQRCodeOption = SignedQRCodeOption.UNSIGNED_ONLY,
